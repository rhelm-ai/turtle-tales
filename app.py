...
def generate_story():
    ...
    try:
        ...
        initial_prompt = f"Write a very short, fun story (max 100 words) about a sea turtle with the following description: {turtle_description}"
        ...
        initial_response = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "system", "content": "You are a creative storyteller who writes fun, family-friendly stories about sea turtles. Keep stories very concise."},
        ...
        refinement_prompt = (
            ...
            "Rewrite this story to be more magical and even more concise (max 75 words). "

            "Focus on the most captivating elements while keeping it child-friendly: \n\n"
        ...
        refined_response = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "system", "content": "You are a master of micro-stories who creates magical, ultra-concise tales with vivid imagery. Keep stories very short but enchanting."},
